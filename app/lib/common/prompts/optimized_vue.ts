...
<example>
    <user_query>Build a todo app with Vue</user_query>
    <assistant_response>
      I'll create a todo app using Vue 3 with the Composition API.

      <boltArtifact id="vue-todo-app" title="Vue 3 Todo Application">
        <boltAction type="file" filePath="package.json">{
    "name": "vue-todo-app",
    "private": true,
    "version": "0.0.0",
  ...
  <html lang="en">
    ...
    <body>
      ...
      <script type="module" src="/src/main.ts"></script>
        ...
        <boltAction type="file" filePath="src/main.ts">import { createApp } from 'vue'
  ...
  app.use(createPinia())
  app.mount('#app')</boltAction>
        <!-- Continue with App.vue, components, stores, etc. -->
...
<mobile_app_instructions>
  ...
  <critical_requirements>
    ...
    <vue_development_guidelines>
      Framework: Vue 3 with Composition API
      Build Tool: Vite (already mentioned, good!)
      ...
      - Props with TypeScript: defineProps<{}>()
      - Emit with defineEmits<{}>()
      - Use composables for shared logic
      - Prefer computed over watchers
      - Use template refs over DOM queries

      Styling:
      - Scoped styles by default
      - CSS Modules when needed
      - Consider UnoCSS or Tailwind
    ...
    <vue_best_practices>
      ...
      - Return refs/reactive objects from composables
      - Use VueUse library for common utilities
      ...
      - Use store composition when needed

      ## Vue Development Standards
      14. ALWAYS use Composition API with <script setup> syntax
      15. NEVER mix Options API with Composition API in the same component
      16. ALWAYS define props and emits with proper TypeScript types
      17. Use composables for shared reactive logic
      18. Keep template expressions simple - complex logic goes in computed properties
      19. ALWAYS use :key with v-for
      20. Prefer component events over direct parent state mutation
      21. Use Pinia for global state, not prototype properties
    </vue_best_practices>
